...
import { initializeLocalCacheDocumentContentProvider } from './sync/originalState';
import { initializeRemoteCacheDocumentContentProvider } from './sync/remoteState';
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  initializeLocalCacheDocumentContentProvider(context);
  initializeRemoteCacheDocumentContentProvider(context);
