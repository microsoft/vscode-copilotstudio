...
export const TelemetryEventsKeys = {
  ...
  RefreshAgentsError: "RefreshAgentsError",
  SignInError: "SignInError",
  RefreshKnowledgeFilesClick: "RefreshKnowledgeFilesClick",
  RefreshKnowledgeFilesSuccess: "RefreshKnowledgeFilesSuccess",
  RefreshKnowledgeFilesError: "RefreshKnowledgeFilesError",
  DownloadKnowledgeFileClick: "DownloadKnowledgeFileClick",
  DownloadKnowledgeFileSuccess: "DownloadKnowledgeFileSuccess",
  ...
  LoadAgentsSuccess: "LoadAgentsSuccess",
  LoadAgentsError: "LoadAgentsError",
  WorkflowFocusNodeError: "WorkflowFocusNodeError",
  WorkflowEditEmbeddedJsonError: "WorkflowEditEmbeddedJsonError",
  WorkflowVisualizeClick: "WorkflowVisualizeClick",
  WorkflowVisualizeSuccess: "WorkflowVisualizeSuccess",
