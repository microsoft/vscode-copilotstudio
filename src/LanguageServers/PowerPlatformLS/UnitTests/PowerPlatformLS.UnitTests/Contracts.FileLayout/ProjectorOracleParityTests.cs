namespace Microsoft.PowerPlatformLS.UnitTests.Contracts.FileLayout
{
    ...
    public class ProjectorOracleParityTests
    {
        ...
        public static TheoryData<string, string, string, string, string, object[], string> OracleCases => new()
        {
            ...
            { "Microsoft.Agents.ObjectModel.TaskDialog", "actions/agent1.component.CustomAction", "agent1.component.CustomAction", "actions/agent1.component.CustomAction.mcs.yml", "FilenameToActionName", new object[] { "agent1.component.CustomAction" }, BotName },
            ...
            { "Microsoft.Agents.ObjectModel.TaskDialog", "actions/Shared.Schema", "Shared.Schema", "actions/Shared.Schema.mcs.yml", "FilenameToActionName", new object[] { "Shared.Schema" }, EmptyBotName },
