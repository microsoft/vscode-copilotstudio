...
{
    using Microsoft.Agents.ObjectModel.InitializableFeatures;
...
""";
        ...
        // Test legacy yaml reader with basic test
        [InlineData("kind: Question\r\nprompt: |+\r\n    012\r\n\r\n    def\r\n    g", false)]
        [InlineData("kind: Question\r\nprompt: |-\r\n    012\r\n\r\n    def\r\n    g", false)]
        [InlineData("kind: Question\r\nprompt: |\r\n    012\r\n\r\n    def\r\n    g", false)]
        public void SyntaxToken_OffsetMapper(string resource, bool useNewYamlReader = true)
        {
            ObjectModelInitializableFeatures.UseNewBreakLineHandlingInYamlReader = useNewYamlReader;
            string[] lineEndings = { "\r\n", "\n" };
