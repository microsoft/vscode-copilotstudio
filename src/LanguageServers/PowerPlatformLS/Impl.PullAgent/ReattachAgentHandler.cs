    ...
    internal class ReattachAgentHandler : IRequestHandler<ReattachAgentRequest, ReattachAgentResponse, RequestContext>
    {
        ...
        public async Task<ReattachAgentResponse> HandleRequestAsync(ReattachAgentRequest request, RequestContext context, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _workspaceSynchronizer.UpsertWorkflowForAgentAsync(workspaceFolder, dataverseClient, agentId, true, cancellationToken);
                await _workspaceSynchronizer.SyncWorkspaceAsync(workspaceFolder, operationContext, changeToken: null, updateWorkspaceDirectory, dataverseClient, agentId, cancellationToken: cancellationToken);
