namespace Microsoft.PowerPlatformLS.Impl.Core.DependencyInjection
{
    ...
    public static class HostApplicationBuilderExtensions
    {
        ...
        public static IHostApplicationBuilder UseLspWindowLogMessageLogging(this IHostApplicationBuilder builder)
        {
            ...
            // Allow Trace level for our code (visible when user selects Trace in VS Code log level).
            // MEL default minimum is Information — framework/SDK loggers naturally stay quiet.
